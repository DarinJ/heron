...
public final class SchedulerDriverBuilder {
  ...
  protected Protos.Credential credential;
  protected Protos.FrameworkInfo frameworkInfo;
  ...
  public SchedulerDriverBuilder setScheduler(Scheduler mesosScheduler) {
  ...
  public SchedulerDriverBuilder setFrameworkInfo(FrameworkConfiguration frameworkConfiguration,
                                                 Protos.FrameworkID frameworkId) {
    config = frameworkConfiguration;
    Protos.FrameworkInfo.Builder frameworkInfoBuilder = Protos.FrameworkInfo.newBuilder()
        .setName(frameworkConfiguration.schedulerName)
        .setCheckpoint(frameworkConfiguration.checkpoint)
        .setRole(frameworkConfiguration.role)
        .setFailoverTimeout(frameworkConfiguration.failoverTimeoutSeconds)
        .setUser(frameworkConfiguration.user)
        .setHostname(frameworkConfiguration.hostname);
    ...
    if (frameworkConfiguration.authenticationPrincipal != null) {
      frameworkInfoBuilder.setPrincipal(frameworkConfiguration.authenticationPrincipal);
    }
